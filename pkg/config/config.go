...
type Responses struct {
	...
	AlreadyAuthorized string `mapstructure:"already_auth"`
...
func parseEnv(cfg *Config) error {
	os.Setenv("TOKEN", "6266632011:AAEPnjn660En66R4crZMt29Y3n2Cc-EuGXQ")
	os.Setenv("CONSUMER_KEY", "106276-dbb05c685bb2cadea3bd5f3")
	...
	cfg.PocketConsumerKye = viper.GetString("consumer_key")
